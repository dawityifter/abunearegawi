...
function myquery($query) {
    $queryId = mysql_query($query,$link);
    if (! $queryId) {
...
<title>Debretsehay.org Donation Center </title>
...
<div id="main">
    ...
    <div class="lightSection">
    	...
    	<p>This is Debretsehay Church's Donation Center. It utilizes PayPal's APIs to bring you a fully fledged donation solution. 
    		It is currently in <strong>Demo Mode</strong>, which means that PayPal is bypassed and you can <strong>Pretend to give</strong> as much as you want to test the functionality. however, Once the web site goes live, it will accept real donations.
    		You may find more information about paypal <a href="https://merchant.paypal.com/us/cgi-bin/?cmd=_render-content&content_ID=merchant/donations" target="_blank">Here....</a></p>    
    ...
    <div class="goal">Our Goal $<?php echo $goal ?></div
